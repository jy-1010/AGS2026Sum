...
public:
	...
	Line3D(VECTOR& pos1, VECTOR& pos2);
	~Line3D(void)override;

	void Update(void)override;
	void Draw(void)override;
	GEOMETRY_TYPE GetType(void)override { return GEOMETRY_TYPE::LINE3D; }
	...
	/// 回転なしBoxとの当たり判定
	/// </summary>
	/// <param name="_box">box情報</param>
	/// <param name="_hitPos">当たった場所</param>
	/// <returns>当たり判定(true当たった)</returns>
