...
SceneGameClear::SceneGameClear(void)
{
	...
	auto menuJson = resManager.GetJsonResource("GameClearJson");
	resManager.GetSound2DResource("GameClearBGM").lock()->Play();
	selectIndex_ = 0;
	maxLayerNum_ = -1;
...
SceneGameClear::~SceneGameClear(void)
{
	...
	auto& resManager = ResourceManager::GetInstance();
	resManager.GetSound2DResource("GameClearBGM").lock()->Stop();
}
...
void SceneGameClear::LoadJson(void)
{
	LoadLogo();
	LoadButton();
}

void SceneGameClear::LoadLogo(void)
{
...
void SceneGameClear::LoadButton(void)
{
...
SceneGameClear::DrawStringInfo SceneGameClear::LoadDrawStringInfo(nlohmann::json stringJson)
{
	DrawStringInfo ret;
...
std::vector<SceneGameClear::ButtonInfo> SceneGameClear::GetButtonInfoToLayer(int layerNum)
{
...
std::vector<SceneGameClear::LogoInfo> SceneGameClear::GetLogoInfoToLayer(int layerNum)
{
...
void SceneGameClear::ChangeScene(void)
{
	std::string next = "";
	for (auto& button : buttonInfo_)
	{
...
void SceneGameClear::DrawButton(ButtonInfo button)
{
	//ボタンのテキスト描画
...
bool SceneGameClear::ColCheckMouse(bool isCheakMove)
{
...
void SceneGameClear::UpdateSelectIndex(void)
{
