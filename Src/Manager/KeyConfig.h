...
public:
	...
	//マウスの移動量を取得
	IntVector2 GetMouseMove(void) const;
	...
	//上を0.0度として角度を渡す
	IntVector2 GetKnockLStickSize(KeyConfig::JOYPAD_NO no) const;
	IntVector2 GetKnockRStickSize(KeyConfig::JOYPAD_NO no) const;
	//指定の方向に倒れた度合い0から1000
